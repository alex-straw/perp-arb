...
class UniswapV3Factory:
    def __init__(self, web3: Web3, contract_dto: ContractDTO):
        ...
        self.contract = web3.eth.contract(address=self.contract_dto.address, abi=get_uniswap_v3_factory_abi())
    ...
    def get_liquidity_pool(self, token_a_dto: ERC20DTO, token_b_dto: ERC20DTO, fee: UniswapFee = UniswapFee.FEE_3000):
        ...
        liquidity_pool_address = self.contract.functions.getPool(self.token_a_dto.address, self.token_b_dto.address, fee.value).call()
